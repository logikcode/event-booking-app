...
import com.bw.commons.security.AccessStatusSource;
import com.bw.commons.security.constraint.AccessConstraint;
            ...
            if (requestPrincipalProvider.get() == null) {
                if (accessConstraints.isEmpty() && (
                        handlerMethod.hasMethodAnnotation(Public.class)
                                ...
                                || (SwaggerWelcomeWebMvc.class.isAssignableFrom(handlerMethod.getBeanType()))
                )) {
                    return true;
                }
