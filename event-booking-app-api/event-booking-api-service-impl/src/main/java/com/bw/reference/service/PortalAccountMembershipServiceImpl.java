...
public class PortalAccountMembershipServiceImpl implements PortalAccountMembershipService {
    ...
    @Transactional
    @Override
    public PortalAccountMembership createMembership(PortalAccount portalAccount, WorkspaceUser user) {
    ...
    @Override
    public List<AccountMembershipPojo> getAllMemberships(WorkspaceUser portalUser) {
