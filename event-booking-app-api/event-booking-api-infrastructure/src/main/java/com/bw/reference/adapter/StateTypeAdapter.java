 ...
 */
package com.bw.reference.adapter;
...
public class StateTypeAdapter extends TypeAdapter<State> {
    ...
    public State read(JsonReader in) throws IOException {
        ...
        return StringUtils.isBlank(value) ? null : locationDao.findByCode(value).orElseThrow(() -> new IllegalArgumentException("State " + value + "cannot be found"));
    }
